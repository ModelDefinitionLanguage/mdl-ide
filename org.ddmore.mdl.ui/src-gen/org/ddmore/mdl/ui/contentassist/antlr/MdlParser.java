		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTaskFunctionStatementAccess().getAlternatives(), "rule__TaskFunctionStatement__Alternatives");
					put(grammarAccess.getBlockStatementAccess().getAlternatives(), "rule__BlockStatement__Alternatives");
					put(grammarAccess.getTargetLanguageAccess().getIdentifierAlternatives_0(), "rule__TargetLanguage__IdentifierAlternatives_0");
					...
					put(grammarAccess.getLevelTypeAccess().getIdentifierAlternatives_0(), "rule__LevelType__IdentifierAlternatives_0");
					put(grammarAccess.getDistributionAccess().getIdentifierAlternatives_0(), "rule__Distribution__IdentifierAlternatives_0");
					...
					put(grammarAccess.getAddListAccess().getIdentifierAssignment_0(), "rule__AddList__IdentifierAssignment_0");
					put(grammarAccess.getAddListAccess().getListAssignment_2(), "rule__AddList__ListAssignment_2");
					put(grammarAccess.getRemoveListAccess().getIdentifierAssignment_0(), "rule__RemoveList__IdentifierAssignment_0");
					...
					put(grammarAccess.getSymbolListAccess().getIdentifierAssignment_0(), "rule__SymbolList__IdentifierAssignment_0");
					...
					put(grammarAccess.getTaskFunctionStatementAccess().getStatementAssignment_0(), "rule__TaskFunctionStatement__StatementAssignment_0");
					put(grammarAccess.getTaskFunctionStatementAccess().getTargetBlockAssignment_1(), "rule__TaskFunctionStatement__TargetBlockAssignment_1");
					...
					put(grammarAccess.getTargetLanguageAccess().getIdentifierAssignment(), "rule__TargetLanguage__IdentifierAssignment");
					...
					put(grammarAccess.getLevelTypeAccess().getIdentifierAssignment(), "rule__LevelType__IdentifierAssignment");
					...
					put(grammarAccess.getDistributionAccess().getIdentifierAssignment(), "rule__Distribution__IdentifierAssignment");
					...
					put(grammarAccess.getListAccess().getIdentifierAssignment_0(), "rule__List__IdentifierAssignment_0");
					put(grammarAccess.getListAccess().getArgumentsAssignment_2(), "rule__List__ArgumentsAssignment_2");
					put(grammarAccess.getOdeListAccess().getIdentifierAssignment_0(), "rule__OdeList__IdentifierAssignment_0");
					put(grammarAccess.getOdeListAccess().getArgumentsAssignment_2(), "rule__OdeList__ArgumentsAssignment_2");
					put(grammarAccess.getRandomListAccess().getIdentifierAssignment_0(), "rule__RandomList__IdentifierAssignment_0");
