...
public class MdlGenerator extends MdlPrinting implements IGenerator {
  ...
  public CharSequence compile(final mcl m) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.append("  \t\t");
      {
        ...
        for(final mcl_obj o_1 : _objects_1) {
          CharSequence _compile = this.compile(o_1);
  ...
  public CharSequence compile(final mcl_obj o) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if (_notEquals) {
        ...
        CharSequence _compile = this.compile(_data_obj_1);
        _builder.append(_compile, "");
      }
    }
    _builder.newLineIfNotEmpty();
    {
      ...
      if (_notEquals_1) {
        ...
        CharSequence _compile_1 = this.compile(_model_obj_1);
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      if (_notEquals_2) {
        ...
        CharSequence _compile_2 = this.compile(_param_obj_1);
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      if (_notEquals_3) {
        task_obj _task_obj_1 = o.getTask_obj();
        CharSequence _compile_3 = this.compile(_task_obj_1);
  ...
  public CharSequence compile(final model_obj o) {
    CharSequence _xblockexpression = null;
    {
  ...
  public CharSequence compile(final param_obj obj) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  public CharSequence compile(final data_obj o) {
    StringConcatenation _builder = new StringConcatenation();
    {
  ...
  public CharSequence compile(final task_obj o) {
    StringConcatenation _builder = new StringConcatenation();
    {
