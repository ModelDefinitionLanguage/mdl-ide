 ...
 * <ul>
 *   <li>{@link org.ddmore.mdl.mdl.impl.verbatim_blockImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.ddmore.mdl.mdl.impl.verbatim_blockImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link org.ddmore.mdl.mdl.impl.verbatim_blockImpl#getExternal_code <em>External code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class verbatim_blockImpl extends MinimalEObjectImpl.Container implements verbatim_block
{
  /**
   ...
   * @generated
   */
  public NotificationChain basicSetBlock(target_block newBlock, NotificationChain msgs)
  {
    target_block oldBlock = block;
    block = newBlock;
    if (eNotificationRequired())
    {
   ...
   * @generated
   */
  public void setBlock(target_block newBlock)
  {
    if (newBlock != block)
    {
  ...
  public void setExternal_code(String newExternal_code)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MdlPackage.VERBATIM_BLOCK__EXTERNAL_CODE, oldExternal_code, external_code));
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case MdlPackage.VERBATIM_BLOCK__IDENTIFIER:
        ...
        return;
      case MdlPackage.VERBATIM_BLOCK__BLOCK:
        setBlock((target_block)newValue);
        return;
      case MdlPackage.VERBATIM_BLOCK__EXTERNAL_CODE:
