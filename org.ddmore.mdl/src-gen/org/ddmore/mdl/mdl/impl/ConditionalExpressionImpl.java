 ...
 * <ul>
 *   <li>{@link org.ddmore.mdl.mdl.impl.ConditionalExpressionImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.ddmore.mdl.mdl.impl.ConditionalExpressionImpl#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link org.ddmore.mdl.mdl.impl.ConditionalExpressionImpl#getExpression2 <em>Expression2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalExpressionImpl extends MinimalEObjectImpl.Container implements ConditionalExpression
{
  ...
  public NotificationChain basicSetExpression(OrExpression newExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MdlPackage.CONDITIONAL_EXPRESSION__EXPRESSION, oldExpression, newExpression);
  ...
  public void setExpression(OrExpression newExpression)
  {
    if (newExpression != expression)
    {
      ...
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MdlPackage.CONDITIONAL_EXPRESSION__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MdlPackage.CONDITIONAL_EXPRESSION__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MdlPackage.CONDITIONAL_EXPRESSION__EXPRESSION, newExpression, newExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MdlPackage.CONDITIONAL_EXPRESSION__EXPRESSION:
